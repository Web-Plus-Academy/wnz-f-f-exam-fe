  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "question-not-visited": "hsl(var(--question-not-visited))",
        "question-visited": "hsl(var(--question-visited))",
        "question-answered": "hsl(var(--question-answered))",
        "question-marked": "hsl(var(--question-marked))",
        "question-marked-answered": "hsl(var(--question-marked-answered))",
